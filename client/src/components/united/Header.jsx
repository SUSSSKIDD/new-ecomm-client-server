                    ...
                    >
                        ...
                        {nearestStore ? (
                            <span className="font-medium">
                                {nearestStore.name} · {nearestStore.pincode}
                                <span className="text-emerald-500 ml-1">({nearestStore.distance}km)</span>
                            </span>
                        ) : locationStatus === 'requesting' ? (
                            <span className="font-medium">Detecting location...</span>
                        ) : locationStatus === 'denied' ? (
                            <span className="font-medium text-orange-600">Location access denied · Tap to retry</span>
                        ) : (
