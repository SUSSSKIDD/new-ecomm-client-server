    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex items-center gap-3 mb-6">
                <RippleButton onClick={onBack} className="p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-full">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">My Addresses</h3>
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-4">
                {loading ? (
                    ...
                    addresses.map((addr) => (
                        <div key={addr.id} className="p-4 border border-gray-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 shadow-sm relative group">
                            <div className="flex justify-between items-start mb-2">
                                <span className={`px-2 py-1 text-xs font-bold rounded-md uppercase ${addr.type === 'HOME' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' :
                                        addr.type === 'WORK' ? 'bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400' : 'bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400'
                                    }`}>
                                    {addr.type}
                                </span>
