            ...
            <div className="container mx-auto">
                <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-gray-50 focus-within:ring-1 focus-within:ring-ud-primary transition-all relative">
                    ...
                    <input
                        ...
                        className="flex-1 px-4 py-2 bg-transparent outline-none text-sm text-gray-700 placeholder-gray-500 w-full min-w-0"
                        value={query || ''}
                        ...
                        <ul>
                            {results.map((product) => (
                                <li
                                    ...
                                    className="px-4 py-2 hover:bg-gray-100 cursor-pointer flex items-center gap-3 border-b border-gray-50 last:border-none"
                                >
                                    {product.images?.[0] && (
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500">{product.subCategory || product.category}</p>
                                    </div>
                ...
                {showResults && !loading && query && results.length === 0 && (
                    <div className="absolute left-0 right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 p-4 text-center text-sm text-gray-500">
                        No products found.
                    </div>
                )}
