            ...
            <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex border border-gray-300 rounded focus-within:border-ud-primary overflow-hidden">
                            <span className="bg-gray-100 border-r border-gray-300 px-3 py-2 text-gray-700 font-medium flex items-center">+91</span>
                            <input
                                type="text"
                                value={phone.replace('+91', '')}
                                onChange={(e) => setPhone('+91' + e.target.value.replace(/\D/g, '').slice(0, 10))}
                                className="w-full p-2 focus:outline-none text-gray-900"
